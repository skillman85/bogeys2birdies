...
import { cmsResponsiveStyle } from '../components/cmsTextStyle';
...
export default async function Home() {
  ...
  const newsletterSettings = {
    ...
    eyebrowStyle: content.newsletter?.eyebrowStyle,
    headingStyle: content.newsletter?.headingStyle,
    descriptionStyle: content.newsletter?.descriptionStyle,
    consentStyle: content.newsletter?.consentStyle,
    noteStyle: content.newsletter?.noteStyle,
  };
  ...
  return <Page siteSettings={content.site || defaultHomeContent.site}>
    <main>
      <section className="hero">
        ...
        <div className="hero-inner"><Eyebrow style={cmsResponsiveStyle(settings.heroEyebrowStyle)}>{settings.heroEyebrow}</Eyebrow><h1 className="cms-text" style={cmsResponsiveStyle(settings.heroTitleStyle)}>{settings.heroTitleLineOne}<br/><em>{settings.heroTitleLineTwo}</em></h1><p className="cms-text" style={cmsResponsiveStyle(settings.heroDescriptionStyle)}>{settings.heroDescription}</p>
      ...
      <section className="road section-shell">
        <div className="section-heading split"><div><Eyebrow style={cmsResponsiveStyle(settings.sectionEyebrowStyle)}>{settings.roadEyebrow}</Eyebrow><h2 className="cms-text" style={cmsResponsiveStyle(settings.sectionHeadingStyle)}>{settings.roadHeading}</h2></div><p className="cms-text" style={cmsResponsiveStyle(settings.sectionDescriptionStyle)}>{settings.roadDescription}</p></div>
      ...
      <section className="experiments dark-section">
        <div className="section-shell"><div className="section-heading split light"><div><Eyebrow style={cmsResponsiveStyle(settings.sectionEyebrowStyle)}>{settings.experimentsEyebrow}</Eyebrow><h2 className="cms-text" style={cmsResponsiveStyle(settings.sectionHeadingStyle)}>{settings.experimentsHeading.split('\n').map((line, index) => <span key={line}>{index > 0 && <br/>}{line}</span>)}</h2></div><p className="cms-text" style={cmsResponsiveStyle(settings.sectionDescriptionStyle)}>{settings.experimentsDescription}</p></div>
      ...
      <section className="manifesto section-shell"><div className="manifesto-mark">“</div><blockquote className="cms-text" style={cmsResponsiveStyle(settings.manifestoHeadingStyle)}>{settings.manifestoHeading}<br/><em className="cms-text" style={cmsResponsiveStyle(settings.manifestoEmphasisStyle)}>{settings.manifestoEmphasis}</em></blockquote><p className="cms-text" style={cmsResponsiveStyle(settings.manifestoDescriptionStyle)}>{settings.manifestoDescription}</p></section>

      <section className="latest section-shell"><div className="section-heading split"><div><Eyebrow style={cmsResponsiveStyle(settings.sectionEyebrowStyle)}>{settings.journalEyebrow}</Eyebrow><h2 className="cms-text" style={cmsResponsiveStyle(settings.sectionHeadingStyle)}>{settings.journalHeading}</h2></div><Link href="/journal" className="text-link">View the journal <Chevron /></Link></div>
