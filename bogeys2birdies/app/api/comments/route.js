...
export async function POST(request) {
  ...
  await client.create({ _type: 'comment', author, message, contentId, contentType, contentTitle: clean(content.title, 160), createdAt: new Date().toISOString(), status: 'pending' });
