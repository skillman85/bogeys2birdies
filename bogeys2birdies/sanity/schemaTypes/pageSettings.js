...
export const pageSettings = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'eyebrowStyle', title: 'Page label style', type: 'textStyle', options: { collapsible: true, collapsed: true } }),
    defineField({ name: 'titleStyle', title: 'Page title style', type: 'textStyle', options: { collapsible: true, collapsed: true } }),
    defineField({ name: 'descriptionStyle', title: 'Page description style', type: 'textStyle', options: { collapsible: true, collapsed: true } }),
